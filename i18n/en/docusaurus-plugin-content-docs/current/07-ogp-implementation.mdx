...
Do not copy the unzipped folder **wholesale**. The diff you inspect in this hands-on is concentrated in `src`, `migrations`, and `test`. Replacing only these three folders avoids unintentionally overwriting root files such as `package.json`.
:::
