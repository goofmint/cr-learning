...
This time's changes all fit inside the following three folders. Use these three folders from the extracted folder to **replace wholesale** the same folders in your own `bookmark-demo` folder.
