...
The goal of this chapter is to display the linked pages' OGP images as thumbnails in the bookmark list.
...
The end of the chapter provides [a way to download the finished version and swap it in](#fallback).
:::
...
You can fetch and swap in the finished code.
...
This time's changes all fit inside the following folders and files. Use these folders and files from the extracted folder to replace the same folders and files in your own `bookmark-demo` folder.
